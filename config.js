...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/f5e0751267307ac475187.mp4'
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'NADEEN-BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Nadeen Poorna' : process.env.OWNER_NAME,
